                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <ul class="text-nowrap" id="images">
                                    ...
                                    <li class="float-left d-inline-block mr-2 mb-2" style="position: relative; width: 32%;">
                                        <form action="/product/{{$product->id}}/image/{{$productImage->id}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                        ...
                                        <div style="width: 100%; height: 220px; overflow: hidden;">
                                            <img  src="dashboard/assets/images/{{$productImage->path}}"
                                            alt="Image">
                                        </div>
                                    </li>
                                    @endforeach
                                    ...
                                    <li class="float-left d-inline-block mr-2 mb-2" style="width: 32%;">
                                        <form method="post" action="/product/{{$product->id}}/image" enctype="multipart/form-data">
                                            @csrf
                        ...
                        <div class="position-relative row form-group mb-1">
                            <div class="col-md-9 col-xl-8 offset-md-3">
                                <a href="/product/{{$product->id}}/edit" class="btn-shadow btn-hover-shine btn btn-primary">
